        ...
        <div class="row">
            <div class="col-12">
              ...
              <ul class="nav">
                ...
                <li><a href="property-details.php"  class="active">Detaily</a></li>
                <li><a href="contact.php">Kontakt</a></li>
                <li><a href="#"><i class="fa fa-calendar"></i>Rezervácia</a></li>
                <a href="admin.php" class="admin-icon" title="Prihlasenie"><i class="fa fa-sign-in-alt"></i>Prihlásenie</a>
              </ul>
